...
\begin{semilogyaxis}[
    % Which column to be taken from each file
        ...
        \foreach \tool in {comparison_cost.2025-07-23_00-37-10.results.PAYNT-CEGIS.xml.bz2.quantile.csv,comparison_cost.2025-07-23_00-37-10.results.SMPMC.xml.bz2.quantile.csv,comparison_cost.2025-07-23_00-37-10.results.SMT(LRA).xml.bz2.quantile.csv} {
