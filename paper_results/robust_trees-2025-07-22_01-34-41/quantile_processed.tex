...
\begin{semilogyaxis}[
    % Which column to be taken from each file
        ...
        \foreach \tool in {comparison_robust_trees.2025-07-22_01-34-41.results.SMPMC.xml.bz2.quantile.csv,comparison_robust_trees.2025-07-22_01-34-41.results.SMT(LRA).xml.bz2.quantile.csv} {
