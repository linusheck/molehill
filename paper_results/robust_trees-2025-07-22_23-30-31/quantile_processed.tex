...
\begin{semilogyaxis}[
    % Which column to be taken from each file
        ...
        legend entries={SMPMC,SMT(LRA),},
        every axis legend/.append style={at={(1,0)}, anchor=south east, outer xsep=5pt, outer ysep=5pt,},
        ]
        \foreach \tool in {comparison_robust_trees.2025-07-22_23-30-31.results.SMPMC.xml.bz2.quantile.csv,comparison_robust_trees.2025-07-22_23-30-31.results.SMT(LRA).xml.bz2.quantile.csv} {
