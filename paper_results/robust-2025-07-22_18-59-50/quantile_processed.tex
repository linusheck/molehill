...
\begin{semilogyaxis}[
    % Which column to be taken from each file
        ...
        legend entries={PAYNT-AR-1-by-1,PAYNT-AR-MDP-Eval,SMPMC,SMT(LRA),},
        every axis legend/.append style={at={(1,0)}, anchor=south east, outer xsep=5pt, outer ysep=5pt,},
        xticklabel style={font=\small},
        yticklabel style={font=\small},
        ]
        \foreach \tool in {comparison_robust.2025-07-22_18-59-51.results.PAYNT-AR-1-by-1.xml.bz2.quantile.csv,comparison_robust.2025-07-22_18-59-51.results.PAYNT-AR-MDP-Eval.xml.bz2.quantile.csv,comparison_robust.2025-07-22_18-59-51.results.SMPMC.xml.bz2.quantile.csv,comparison_robust.2025-07-22_18-59-51.results.SMT(LRA).xml.bz2.quantile.csv} {
