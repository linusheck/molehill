...
\begin{semilogyaxis}[
    % Which column to be taken from each file
        ...
        \foreach \tool in {comparison_trees.2025-07-21_13-34-43.results.PAYNT-CEGIS.xml.bz2.quantile.csv,comparison_trees.2025-07-21_13-34-43.results.SMPMC.xml.bz2.quantile.csv,comparison_trees.2025-07-21_13-34-43.results.SMT(LRA).xml.bz2.quantile.csv} {
