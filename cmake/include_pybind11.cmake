...
#    message(STATUS "Stormpy - Using system version of pybind11 (version ${PYBIND_VERSION}).")
    ...
    FetchContent_Declare(
        ...
        PATCH_COMMAND git apply ${CMAKE_CURRENT_SOURCE_DIR}/cmake/pybind11_${PYBIND_VERSION}.patch || git apply ${CMAKE_CURRENT_SOURCE_DIR}/cmake/pybind11_${PYBIND_VERSION}.patch --reverse --check
    )
